# Development mode
To run the Docker setup with the web service in development mode with Hot Module Reload, run `docker compose -f docker-compose.yml -f docker-compose.dev.yml up web postgres migrator init_rsa_keys scraper`.
