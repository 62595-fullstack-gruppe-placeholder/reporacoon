...
export default async function Page({
  ...
  try {
    ...
    return (
      <SharePage job={job} findings={findings}>
        <ServerRenderedContent job={job} />
      </SharePage>
    );
  } catch {
    notFound();
...
function ServerRenderedContent({ job }: { job: ScanJob }) {
  return (
    <>
      <h1 className="h1 text-center pb-8">
        This scan job has been shared with you
      </h1>
