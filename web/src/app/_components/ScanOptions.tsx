                        ...
                        <Field orientation="horizontal" data-disabled >
                            <TooltipTrigger asChild>
                                <div className="w-full flex gap-2">
                                    <Checkbox id="scan-type-shallow" name="scan-type-shallow" checked={checkedShallow} onCheckedChange={onCheckShallow} disabled />
                                    <FieldContent>
                                    ...
                                    <Checkbox id="scan-type-deep" name="scan-type-deep" checked={checkedDeep} onCheckedChange={onCheckDeep} disabled />
                                    <FieldContent>
